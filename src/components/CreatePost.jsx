...
const CreatePost = () => {
    const [post, setPost] = useState({ title:'', caption:'', image_url:'', secret_key:'', likes: 0, comments: [] });
  ...
  return (
    <div className="form-container">
        <form onSubmit={createPost}>
            ...
            <br />
            <input type="password" value={post.secret_key} name="secret_key" onChange={handleChange} />
            <br />
            <br />
